...
private const val ANY_CHAT_MEMBER_STATUS = "member" // also "creator", "administrator", "restricted", "left" and "kicked" are available

fun anyChatMember(
    user: User = anyUser(),
    status: String = ANY_CHAT_MEMBER_STATUS,
